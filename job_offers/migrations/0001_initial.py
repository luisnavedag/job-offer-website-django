    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ManyToManyField(to='job_offers.city')),
                ...
                ('subscription', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='employer.subscription')),
            ],
        ),
    ]
